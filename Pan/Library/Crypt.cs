...
namespace PadText.Library
{
    ...
    public class PadCrypt : ICrypt
    {
        ...
        public PadCrypt(string padStr)
        {
            ...
            for (int i = 0; i < PadCrypt.dictionaryToChar.Length; i++)
            {
                this.dictionaryToInt.Add(PadCrypt.dictionaryToChar[i], i);
            }
        }
        ...
        public static char[] dictionaryToChar = " @£$¥èéùìòÇØøÅåΔ_ΦΓΛΩΠΨΣΘΞÆæßÉ!\"#¤%&'()*+,-./0123456789:;<=>?¡ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÑÜ§¿abcdefghijklmnopqrstuvwxyzäöñüà~\\^".ToArray();
    }
}
